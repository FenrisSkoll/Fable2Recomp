...
- **Extended coverage:** [Phase 5A tranche 001](docs/fable2-discovery-pipeline/09-phase5a-tranche-001.md) records Bowerstone Market-to-Oakfield reference coverage and one reviewed thunk import; the short native Oakfield endpoint smoke test is pending. Its [session contract](docs/fable2-discovery-pipeline/coverage/README.md) keeps user-confirmed coverage and pending evidence explicit.
