...
- **Extended coverage:** [Phase 5A](docs/fable2-discovery-pipeline/08-phase5a-runtime-coverage.md) prepares forward-only Xenia collection followed by a short native endpoint smoke test; its [session contract](docs/fable2-discovery-pipeline/coverage/README.md) keeps user-confirmed coverage and pending evidence explicit.
