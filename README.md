...
- **GPU configuration preparation:** [NR0B-1](docs/fable2-native-renderer/nr0b1/README.md) provides a default-off configuration snapshot and an isolated Oakfield run card. Preparation is complete; effective selections and loaded-module identity await the user-operated run. No native renderer or per-draw recorder is implemented.
