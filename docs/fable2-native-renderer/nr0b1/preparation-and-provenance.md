...
| [Native save parity](../../fable2-native-save/fable2-native-save-write-parity.md), [testing contract](../../fable2-discovery-pipeline/coverage/README.md), [completed Phase 5A](../../fable2-discovery-pipeline/09-phase5a-tranche-001.md) | Latest Oakfield checkpoint, seven payloads/platform metadata, isolated-root exception, actual-process monitoring |
